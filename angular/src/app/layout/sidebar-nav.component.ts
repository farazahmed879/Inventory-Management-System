...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        ...
        new MenuItem(this.l('Sale'), '','home', '/app/productSale'), 
        new MenuItem(this.l('My Product'), '','business', '/app/shopProduct'),
        ...
        new MenuItem(this.l('Catagory'), '','business', '/app/productCatagory'),      
        new MenuItem(this.l('Branch'), '','business', '/app/type'),
