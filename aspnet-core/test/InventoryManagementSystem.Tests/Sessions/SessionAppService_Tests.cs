...
using Shouldly;
using Xunit;
using InventoryManagementSystem.Sessions;

namespace InventoryManagementSystem.Tests.Sessions
{
    public class SessionAppService_Tests : InventoryManagementSystemTestBase
    {
